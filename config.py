...
workspace = "/home/rinirey/Projects/htsat/HTS-Audio-Transformer" # the folder of your code
dataset_path = "/home/rinirey/Projects/htsat/HTS-Audio-Transformer/workspace/UrbanSound8k" # the dataset path
desed_folder = "/home/rinirey/Projects/htsat/HTS-Audio-Transformer/DESED" # the desed file

dataset_type = "UrbanSound8k" # "audioset" "esc-50" "scv2" "UrbanSound8k"
...
resume_checkpoint = "./checkpoint/US8K-acc=0.891.ckpt"
...
sample_rate = 44100 # 16000 for scv2, 32000 for audioset and esc-50, 44100 for us8k
clip_samples = sample_rate * 4 # audio_set 10-sec clip
window_size = 1024
hop_size = 441 # 160 for scv2, 320 for audioset and esc-50, 441 for us8k
mel_bins = 64
fmin = 50
fmax = 14000
...
# for data collection
classes_num = 10 # esc: 50 | audioset: 527 | scv2: 35 | us8k: 10
