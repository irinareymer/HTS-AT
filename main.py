...
from data_generator import SEDDataset, DESED_Dataset, ESC_Dataset, SCV2_Dataset, UrbanSound8k_Dataset
...
def test():
    ...
    if config.fl_local:
        ...
        elif config.dataset_type == "UrbanSound8k":
